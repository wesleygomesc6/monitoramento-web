      ...
      this.$axios
        .$get(
          this.search == "" || this.search == null
            ? `pessoas?_page=${this.paginacao.pageNumber}&_limit=${this.paginacao.pageSize}`
            : `pessoas?_page=${this.paginacao.pageNumber}&_limit=${this.paginacao.pageSize}&q=${this.search}`
        )
        .then((res) => {
          this.items = res;

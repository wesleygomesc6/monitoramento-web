      ...
      this.$axios
        .$get(
          this.search == "" || this.search == null
            ? `${this.$config.inventarioURL}clusters?page=${this.paginacao.pageNumber}&size=${this.paginacao.pageSize}`
            : `${this.$config.inventarioURL}clusters?page=${this.paginacao.pageNumber}&size=${this.paginacao.pageSize}&nome=${this.search}`
        )
        .then((res) => {

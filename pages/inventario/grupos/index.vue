...
<script>
import Grupo from "@/models/inventario/Grupo";
export default {
  data() {
    return {
      items: [],
      ...
      this.$axios
        .$get(
          this.search == "" || this.search == null
            ? `${this.$config.inventarioURL}grupos?page=${this.paginacao.pageNumber}&size=${this.paginacao.pageSize}`
            : `${this.$config.inventarioURL}grupos?page=${this.paginacao.pageNumber}&size=${this.paginacao.pageSize}&nome=${this.search}`
        )
        .then((res) => {

      ...
      this.$axios
        .$get(
          this.search == "" || this.search == null
            ? `grupos?_page=${this.paginacao.pageNumber}&_limit=${this.paginacao.pageSize}`
            : `grupos?_page=${this.paginacao.pageNumber}&_limit=${this.paginacao.pageSize}&q=${this.search}`
        )
        .then((res) => {
          this.items = res;

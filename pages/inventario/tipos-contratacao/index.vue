      ...
      this.$axios
        .$get(
          this.search == "" || this.search == null
            ? `tipos-contratacao?_page=${this.paginacao.pageNumber}&_limit=${this.paginacao.pageSize}`
            : `tipos-contratacao?_page=${this.paginacao.pageNumber}&_limit=${this.paginacao.pageSize}&q=${this.search}`
        )
        .then((res) => {
          this.items = res;
